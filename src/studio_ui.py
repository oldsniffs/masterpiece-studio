...
"}")
        ...
        self.prime_top = QWidget(self.prime_weights_widget)
        self.prime_top.setObjectName(u"prime_top")
        self.horizontalLayout_41 = QHBoxLayout(self.prime_top)
        self.horizontalLayout_41.setSpacing(0)
        self.horizontalLayout_41.setObjectName(u"horizontalLayout_41")
        self.horizontalLayout_41.setContentsMargins(0, 0, 0, 0)
        self.prime_label = QLabel(self.prime_top)
        self.prime_label.setObjectName(u"prime_label")
        sizePolicy15 = QSizePolicy(QSizePolicy.MinimumExpanding, QSizePolicy.Fixed)
        sizePolicy15.setHorizontalStretch(0)
        sizePolicy15.setVerticalStretch(0)
        sizePolicy15.setHeightForWidth(self.prime_label.sizePolicy().hasHeightForWidth())
        self.prime_label.setSizePolicy(sizePolicy15)
        self.prime_label.setMinimumSize(QSize(0, 40))
        self.prime_label.setMaximumSize(QSize(16777215, 40))
        font4 = QFont()
        font4.setPointSize(11)
        font4.setBold(False)
        self.prime_label.setFont(font4)
        self.prime_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)

        self.horizontalLayout_41.addWidget(self.prime_label)

        self.prime_total_label = QLabel(self.prime_top)
        self.prime_total_label.setObjectName(u"prime_total_label")
        self.prime_total_label.setAlignment(Qt.AlignRight|Qt.AlignTop|Qt.AlignTrailing)

        self.horizontalLayout_41.addWidget(self.prime_total_label)

        self.prime_total_display = QLabel(self.prime_top)
        self.prime_total_display.setObjectName(u"prime_total_display")
        sizePolicy9.setHeightForWidth(self.prime_total_display.sizePolicy().hasHeightForWidth())
        self.prime_total_display.setSizePolicy(sizePolicy9)
        self.prime_total_display.setMinimumSize(QSize(40, 0))
        self.prime_total_display.setMaximumSize(QSize(40, 16777215))
        self.prime_total_display.setAlignment(Qt.AlignRight|Qt.AlignTop|Qt.AlignTrailing)

        self.horizontalLayout_41.addWidget(self.prime_total_display)


        self.verticalLayout_16.addWidget(self.prime_top)
...
"}")
        ...
        self.pair_top = QWidget(self.pair_weights_widget)
        self.pair_top.setObjectName(u"pair_top")
        self.horizontalLayout_42 = QHBoxLayout(self.pair_top)
        self.horizontalLayout_42.setSpacing(0)
        self.horizontalLayout_42.setObjectName(u"horizontalLayout_42")
        self.horizontalLayout_42.setContentsMargins(0, 0, 0, 0)
        self.pair_label = QLabel(self.pair_top)
        self.pair_label.setObjectName(u"pair_label")
        sizePolicy15.setHeightForWidth(self.pair_label.sizePolicy().hasHeightForWidth())
        self.pair_label.setSizePolicy(sizePolicy15)
        self.pair_label.setMinimumSize(QSize(0, 40))
        self.pair_label.setMaximumSize(QSize(16777215, 40))
        self.pair_label.setFont(font4)
        self.pair_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)

        self.horizontalLayout_42.addWidget(self.pair_label)

        self.pair_total_label = QLabel(self.pair_top)
        self.pair_total_label.setObjectName(u"pair_total_label")
        self.pair_total_label.setAlignment(Qt.AlignRight|Qt.AlignTop|Qt.AlignTrailing)

        self.horizontalLayout_42.addWidget(self.pair_total_label)

        self.pair_total_display = QLabel(self.pair_top)
        self.pair_total_display.setObjectName(u"pair_total_display")
        sizePolicy9.setHeightForWidth(self.pair_total_display.sizePolicy().hasHeightForWidth())
        self.pair_total_display.setSizePolicy(sizePolicy9)
        self.pair_total_display.setMinimumSize(QSize(40, 0))
        self.pair_total_display.setMaximumSize(QSize(40, 16777125))
        self.pair_total_display.setAlignment(Qt.AlignRight|Qt.AlignTop|Qt.AlignTrailing)

        self.horizontalLayout_42.addWidget(self.pair_total_display)


        self.verticalLayout_34.addWidget(self.pair_top)
...
"}")
        ...
        sizePolicy16 = QSizePolicy(QSizePolicy.Maximum, QSizePolicy.Preferred)
        sizePolicy16.setHorizontalStretch(0)
        sizePolicy16.setVerticalStretch(0)
        sizePolicy16.setHeightForWidth(self.pair_len_weights_widget.sizePolicy().hasHeightForWidth())
        self.pair_len_weights_widget.setSizePolicy(sizePolicy16)
...
"}")
        ...
        sizePolicy17.setHeightForWidth(self.keysig_widget.sizePolicy().hasHeightForWidth())
        self.keysig_widget.setSizePolicy(sizePolicy17)
        ...
        self.keysig_pitch_combo.setFont(font6)
        ...
        self.keysig_acc_combo.setFont(font6)
        ...
        self.keysig_scale_combo.setFont(font6)
        ...
        sizePolicy18.setHorizontalStretch(5)
        sizePolicy18.setVerticalStretch(0)
        sizePolicy18.setHeightForWidth(self.keysig_spacewidget.sizePolicy().hasHeightForWidth())
        self.keysig_spacewidget.setSizePolicy(sizePolicy18)
        ...
        sizePolicy19 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Maximum)
        sizePolicy19.setHorizontalStretch(6)
        sizePolicy19.setVerticalStretch(0)
        sizePolicy19.setHeightForWidth(self.ranges_widget.sizePolicy().hasHeightForWidth())
        self.ranges_widget.setSizePolicy(sizePolicy19)
...
"}")
        ...
        self.sharp_ranges.setFont(font7)
...
"}")
        ...
        self.flat_ranges.setFont(font7)
...
"}")
        ...
        sizePolicy20.setHeightForWidth(self.spacerwidget_2.sizePolicy().hasHeightForWidth())
        self.spacerwidget_2.setSizePolicy(sizePolicy20)
        ...
        sizePolicy21 = QSizePolicy(QSizePolicy.Maximum, QSizePolicy.Maximum)
        sizePolicy21.setHorizontalStretch(6)
        sizePolicy21.setVerticalStretch(0)
        sizePolicy21.setHeightForWidth(self.anchors_arch_widget.sizePolicy().hasHeightForWidth())
        self.anchors_arch_widget.setSizePolicy(sizePolicy21)
        ...
        font8.setBold(True)
        self.anchors_label.setFont(font8)
...
"}")
        ...
        sizePolicy16.setHeightForWidth(self.anchor_templates_label.sizePolicy().hasHeightForWidth())
        self.anchor_templates_label.setSizePolicy(sizePolicy16)
...
"}")
        ...
        sizePolicy22 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        sizePolicy22.setHorizontalStretch(2)
        sizePolicy22.setVerticalStretch(0)
        sizePolicy22.setHeightForWidth(self.anchors_config_combo.sizePolicy().hasHeightForWidth())
        self.anchors_config_combo.setSizePolicy(sizePolicy22)
        self.anchors_config_combo.setMaximumSize(QSize(300, 25))
        self.anchors_config_combo.setFont(font6)
        ...
        sizePolicy23.setHeightForWidth(self.anchors_save_template.sizePolicy().hasHeightForWidth())
        self.anchors_save_template.setSizePolicy(sizePolicy23)
        self.anchors_save_template.setMaximumSize(QSize(16777215, 40))
        self.anchors_save_template.setFont(font6)
        ...
        sizePolicy24.setHeightForWidth(self.anchors_refresh_template.sizePolicy().hasHeightForWidth())
        self.anchors_refresh_template.setSizePolicy(sizePolicy24)
        self.anchors_refresh_template.setMaximumSize(QSize(16777215, 40))
        self.anchors_refresh_template.setFont(font6)
        ...
        sizePolicy24.setHeightForWidth(self.anchors_delete_template.sizePolicy().hasHeightForWidth())
        self.anchors_delete_template.setSizePolicy(sizePolicy24)
        self.anchors_delete_template.setMaximumSize(QSize(16777215, 40))
        self.anchors_delete_template.setFont(font6)
...
"}")
        ...
        sizePolicy16.setHeightForWidth(self.tertiary_spawn_dial.sizePolicy().hasHeightForWidth())
        self.tertiary_spawn_dial.setSizePolicy(sizePolicy16)
        ...
        sizePolicy9.setHeightForWidth(self.tertiary_spawn_display.sizePolicy().hasHeightForWidth())
        self.tertiary_spawn_display.setSizePolicy(sizePolicy9)
        self.tertiary_spawn_display.setMinimumSize(QSize(40, 0))
        self.tertiary_spawn_display.setMaximumSize(QSize(40, 16777215))
        self.tertiary_spawn_display.setAlignment(Qt.AlignCenter)
        ...
        sizePolicy16.setHeightForWidth(self.secondary_spawn_dial.sizePolicy().hasHeightForWidth())
        self.secondary_spawn_dial.setSizePolicy(sizePolicy16)
        ...
        sizePolicy9.setHeightForWidth(self.secondary_spawn_display.sizePolicy().hasHeightForWidth())
        self.secondary_spawn_display.setSizePolicy(sizePolicy9)
        self.secondary_spawn_display.setMinimumSize(QSize(40, 0))
        self.secondary_spawn_display.setMaximumSize(QSize(40, 16777215))
        self.secondary_spawn_display.setAlignment(Qt.AlignCenter)
        ...
        sizePolicy16.setHeightForWidth(self.secondary_longevity_dial.sizePolicy().hasHeightForWidth())
        self.secondary_longevity_dial.setSizePolicy(sizePolicy16)
        ...
        sizePolicy9.setHeightForWidth(self.secondary_longevity_display.sizePolicy().hasHeightForWidth())
        self.secondary_longevity_display.setSizePolicy(sizePolicy9)
        self.secondary_longevity_display.setMinimumSize(QSize(40, 0))
        self.secondary_longevity_display.setMaximumSize(QSize(40, 16777215))
        self.secondary_longevity_display.setAlignment(Qt.AlignCenter)
        ...
        sizePolicy16.setHeightForWidth(self.tertiary_longevity_dial.sizePolicy().hasHeightForWidth())
        self.tertiary_longevity_dial.setSizePolicy(sizePolicy16)
        ...
        sizePolicy9.setHeightForWidth(self.tertiary_longevity_display.sizePolicy().hasHeightForWidth())
        self.tertiary_longevity_display.setSizePolicy(sizePolicy9)
        self.tertiary_longevity_display.setMinimumSize(QSize(40, 0))
        self.tertiary_longevity_display.setMaximumSize(QSize(40, 16777215))
        self.tertiary_longevity_display.setAlignment(Qt.AlignCenter)
        ...
        sizePolicy16.setHeightForWidth(self.primary_label.sizePolicy().hasHeightForWidth())
        self.primary_label.setSizePolicy(sizePolicy16)
        ...
        sizePolicy16.setHeightForWidth(self.primary_gravity_dial.sizePolicy().hasHeightForWidth())
        self.primary_gravity_dial.setSizePolicy(sizePolicy16)
        ...
        sizePolicy9.setHeightForWidth(self.primary_gravity_display.sizePolicy().hasHeightForWidth())
        self.primary_gravity_display.setSizePolicy(sizePolicy9)
        self.primary_gravity_display.setMinimumSize(QSize(40, 0))
        self.primary_gravity_display.setMaximumSize(QSize(40, 16777215))
        self.primary_gravity_display.setAlignment(Qt.AlignCenter)
        ...
        sizePolicy16.setHeightForWidth(self.secondary_label.sizePolicy().hasHeightForWidth())
        self.secondary_label.setSizePolicy(sizePolicy16)
        ...
        sizePolicy16.setHeightForWidth(self.secondary_gravity_dial.sizePolicy().hasHeightForWidth())
        self.secondary_gravity_dial.setSizePolicy(sizePolicy16)
        ...
        sizePolicy9.setHeightForWidth(self.secondary_gravity_display.sizePolicy().hasHeightForWidth())
        self.secondary_gravity_display.setSizePolicy(sizePolicy9)
        self.secondary_gravity_display.setMinimumSize(QSize(40, 0))
        self.secondary_gravity_display.setMaximumSize(QSize(40, 16777215))
        self.secondary_gravity_display.setAlignment(Qt.AlignCenter)
        ...
        sizePolicy16.setHeightForWidth(self.tertiary_label.sizePolicy().hasHeightForWidth())
        self.tertiary_label.setSizePolicy(sizePolicy16)
...
"}")
        ...
        sizePolicy16.setHeightForWidth(self.tertiary_gravity_dial.sizePolicy().hasHeightForWidth())
        self.tertiary_gravity_dial.setSizePolicy(sizePolicy16)
        ...
        sizePolicy9.setHeightForWidth(self.tertiary_gravity_display.sizePolicy().hasHeightForWidth())
        self.tertiary_gravity_display.setSizePolicy(sizePolicy9)
        self.tertiary_gravity_display.setMinimumSize(QSize(40, 0))
        self.tertiary_gravity_display.setMaximumSize(QSize(40, 16777215))
        self.tertiary_gravity_display.setAlignment(Qt.AlignCenter)
...
"}")
        ...
        sizePolicy16.setHeightForWidth(self.tertiary_velocity_dial.sizePolicy().hasHeightForWidth())
        self.tertiary_velocity_dial.setSizePolicy(sizePolicy16)
        ...
        sizePolicy9.setHeightForWidth(self.tertiary_velocity_display.sizePolicy().hasHeightForWidth())
        self.tertiary_velocity_display.setSizePolicy(sizePolicy9)
        self.tertiary_velocity_display.setMinimumSize(QSize(40, 0))
        self.tertiary_velocity_display.setMaximumSize(QSize(40, 16777215))
        self.tertiary_velocity_display.setAlignment(Qt.AlignCenter)
        ...
        sizePolicy16.setHeightForWidth(self.secondary_velocity_dial.sizePolicy().hasHeightForWidth())
        self.secondary_velocity_dial.setSizePolicy(sizePolicy16)
        ...
        sizePolicy9.setHeightForWidth(self.secondary_velocity_display.sizePolicy().hasHeightForWidth())
        self.secondary_velocity_display.setSizePolicy(sizePolicy9)
        self.secondary_velocity_display.setMinimumSize(QSize(40, 0))
        self.secondary_velocity_display.setMaximumSize(QSize(40, 16777215))
        self.secondary_velocity_display.setAlignment(Qt.AlignCenter)
        ...
        sizePolicy16.setHeightForWidth(self.primary_velocity_dial.sizePolicy().hasHeightForWidth())
        self.primary_velocity_dial.setSizePolicy(sizePolicy16)
        ...
        sizePolicy9.setHeightForWidth(self.primary_velocity_display.sizePolicy().hasHeightForWidth())
        self.primary_velocity_display.setSizePolicy(sizePolicy9)
        self.primary_velocity_display.setMinimumSize(QSize(40, 0))
        self.primary_velocity_display.setMaximumSize(QSize(40, 16777215))
        self.primary_velocity_display.setAlignment(Qt.AlignCenter)
        ...
        sizePolicy25 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy25.setHorizontalStretch(2)
        sizePolicy25.setVerticalStretch(0)
        sizePolicy25.setHeightForWidth(self.spacerwidget.sizePolicy().hasHeightForWidth())
        self.spacerwidget.setSizePolicy(sizePolicy25)
        ...
        sizePolicy16.setHeightForWidth(self.widget_3.sizePolicy().hasHeightForWidth())
        self.widget_3.setSizePolicy(sizePolicy16)
...
"")
        ...
        sizePolicy16.setHeightForWidth(self.compose_active_configuration_label.sizePolicy().hasHeightForWidth())
        self.compose_active_configuration_label.setSizePolicy(sizePolicy16)
...
"")
        ...
        sizePolicy16.setHeightForWidth(self.widget_16.sizePolicy().hasHeightForWidth())
        self.widget_16.setSizePolicy(sizePolicy16)
        ...
        self.filepath_display.setFont(font7)
...
"}")
        ...
        sizePolicy16.setHeightForWidth(self.version_display.sizePolicy().hasHeightForWidth())
        self.version_display.setSizePolicy(sizePolicy16)
...
"}")
        ...
        self.active_style_label.setFont(font6)
        ...
        self.active_configuration_label.setFont(font6)
        ...
        self.topBar_active_style_display.setFont(font6)
...
"}")
        ...
        self.topBar_active_configuration_display.setFont(font6)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.prime_label.setText(QCoreApplication.translate("MainWindow", u"Prime Roll", None))
        self.prime_total_label.setText(QCoreApplication.translate("MainWindow", u"Cumulative Weight Total:", None))
        self.prime_total_display.setText(QCoreApplication.translate("MainWindow", u"##", None))
        ...
        self.pair_label.setText(QCoreApplication.translate("MainWindow", u"Pair Roll", None))
        self.pair_total_label.setText(QCoreApplication.translate("MainWindow", u"Cumulative Weight Total:", None))
        self.pair_total_display.setText(QCoreApplication.translate("MainWindow", u"##", None))
        ...
        self.keysig_scale_combo.setItemText(2, QCoreApplication.translate("MainWindow", u"Harmonic Minor", None))
        self.keysig_scale_combo.setItemText(3, QCoreApplication.translate("MainWindow", u"Melodic Minor", None))
        self.keysig_scale_combo.setItemText(4, QCoreApplication.translate("MainWindow", u"Dorian", None))
        self.keysig_scale_combo.setItemText(5, QCoreApplication.translate("MainWindow", u"Phrygian", None))
        self.keysig_scale_combo.setItemText(6, QCoreApplication.translate("MainWindow", u"Lydian", None))
        self.keysig_scale_combo.setItemText(7, QCoreApplication.translate("MainWindow", u"Mixolydian", None))
        self.keysig_scale_combo.setItemText(8, QCoreApplication.translate("MainWindow", u"Aeolian", None))
        self.keysig_scale_combo.setItemText(9, QCoreApplication.translate("MainWindow", u"Locrian", None))
