...
"}")
        ...
        self.timesig_bar_2 = QWidget(self.timing_spacewidget)
        self.timesig_bar_2.setObjectName(u"timesig_bar_2")
        sizePolicy6 = QSizePolicy(QSizePolicy.Maximum, QSizePolicy.Maximum)
        sizePolicy6.setHorizontalStretch(0)
        sizePolicy6.setVerticalStretch(0)
        sizePolicy6.setHeightForWidth(self.timesig_bar_2.sizePolicy().hasHeightForWidth())
        self.timesig_bar_2.setSizePolicy(sizePolicy6)
        self.timesig_bar_2.setMaximumSize(QSize(300, 114))
        self.timesig_bar = QHBoxLayout(self.timesig_bar_2)
        self.timesig_bar.setSpacing(2)
        self.timesig_bar.setObjectName(u"timesig_bar")
        self.timesig_bar.setContentsMargins(0, 0, 0, 0)
        self.timesig_label = QLabel(self.timesig_bar_2)
        self.timesig_label.setObjectName(u"timesig_label")
        sizePolicy7 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy7.setHorizontalStretch(0)
        sizePolicy7.setVerticalStretch(0)
        sizePolicy7.setHeightForWidth(self.timesig_label.sizePolicy().hasHeightForWidth())
        self.timesig_label.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.timesig_bar.addItem(self.horizontalSpacer_5)

        self.timesig_box = QWidget(self.timesig_bar_2)
        self.timesig_box.setObjectName(u"timesig_box")
        sizePolicy8 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Preferred)
        sizePolicy8.setHorizontalStretch(0)
        sizePolicy8.setVerticalStretch(0)
        sizePolicy8.setHeightForWidth(self.timesig_box.sizePolicy().hasHeightForWidth())
        self.timesig_box.setSizePolicy(sizePolicy8)
        ...
        sizePolicy9.setHeightForWidth(self.timesig_num.sizePolicy().hasHeightForWidth())
        self.timesig_num.setSizePolicy(sizePolicy9)
        ...
        sizePolicy7.setHeightForWidth(self.timesig_line.sizePolicy().hasHeightForWidth())
        self.timesig_line.setSizePolicy(sizePolicy7)
        ...
        self.horizontalLayout_2.addWidget(self.timesig_bar_2)
        ...
        sizePolicy7.setHeightForWidth(self.bpm_label.sizePolicy().hasHeightForWidth())
        self.bpm_label.setSizePolicy(sizePolicy7)
...
"}")
        ...
        sizePolicy9.setHeightForWidth(self.bpm_entry.sizePolicy().hasHeightForWidth())
        self.bpm_entry.setSizePolicy(sizePolicy9)
        ...
        self.horizontalSpacer = QSpacerItem(1087, 179, QSizePolicy.Expanding, QSizePolicy.Minimum)
...
"}")
        ...
        self.verticalLayout_5.addWidget(self.weights_label)
        ...
        sizePolicy8.setHeightForWidth(self.notes_images.sizePolicy().hasHeightForWidth())
        self.notes_images.setSizePolicy(sizePolicy8)
        ...
        sizePolicy7.setHeightForWidth(self.whole_weight_image_2.sizePolicy().hasHeightForWidth())
        self.whole_weight_image_2.setSizePolicy(sizePolicy7)
...
"}")
        ...
        sizePolicy7.setHeightForWidth(self.half_weight_image_2.sizePolicy().hasHeightForWidth())
        self.half_weight_image_2.setSizePolicy(sizePolicy7)
...
"}")
        ...
        sizePolicy7.setHeightForWidth(self.quarter_weight_image_2.sizePolicy().hasHeightForWidth())
        self.quarter_weight_image_2.setSizePolicy(sizePolicy7)
...
"}")
        ...
        sizePolicy7.setHeightForWidth(self.eighth_weight_image_2.sizePolicy().hasHeightForWidth())
        self.eighth_weight_image_2.setSizePolicy(sizePolicy7)
...
"}")
        ...
        sizePolicy7.setHeightForWidth(self.sixteenth_weight_image_4.sizePolicy().hasHeightForWidth())
        self.sixteenth_weight_image_4.setSizePolicy(sizePolicy7)
...
"}")
        ...
        sizePolicy7.setHeightForWidth(self.sixteenth_weight_image_5.sizePolicy().hasHeightForWidth())
        self.sixteenth_weight_image_5.setSizePolicy(sizePolicy7)
...
"}")
        ...
        sizePolicy7.setHeightForWidth(self.sixteenth_weight_image_6.sizePolicy().hasHeightForWidth())
        self.sixteenth_weight_image_6.setSizePolicy(sizePolicy7)
...
"}")
        ...
        sizePolicy10.setHeightForWidth(self.prime_weights_widget.sizePolicy().hasHeightForWidth())
        self.prime_weights_widget.setSizePolicy(sizePolicy10)
...
"}")
        ...
        self.whole_prime_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_10.sizePolicy().hasHeightForWidth())
        self.dotted_10.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.dwhole_prime_slider.setMaximum(30)
...
"")
        ...
        self.half_prime_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_9.sizePolicy().hasHeightForWidth())
        self.dotted_9.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.dhalf_prime_slider.setMaximum(30)
...
"}")
        ...
        self.quarter_prime_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_3.sizePolicy().hasHeightForWidth())
        self.dotted_3.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.dquarter_prime_slider.setMaximum(30)
...
"}")
        ...
        self.eighth_prime_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_8.sizePolicy().hasHeightForWidth())
        self.dotted_8.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.deighth_prime_slider.setMaximum(30)
...
"}")
        ...
        self.sixteenth_prime_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_7.sizePolicy().hasHeightForWidth())
        self.dotted_7.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.dsixteenth_prime_slider.setMaximum(30)
...
"}")
        ...
        self.thirtysecond_prime_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_11.sizePolicy().hasHeightForWidth())
        self.dotted_11.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.dthirtysecond_prime_slider.setMaximum(30)
...
"}")
        ...
        self.sixtyfourth_prime_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_12.sizePolicy().hasHeightForWidth())
        self.dotted_12.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.dsixtyfourth_prime_slider.setMaximum(30)
        ...
        sizePolicy10.setHeightForWidth(self.pair_weights_widget.sizePolicy().hasHeightForWidth())
        self.pair_weights_widget.setSizePolicy(sizePolicy10)
...
"}")
        ...
        self.whole_pair_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_5.sizePolicy().hasHeightForWidth())
        self.dotted_5.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.dwhole_pair_slider.setMaximum(30)
...
"}")
        ...
        self.half_pair_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_6.sizePolicy().hasHeightForWidth())
        self.dotted_6.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.dhalf_pair_slider.setMaximum(30)
...
"}")
        ...
        self.quarter_pair_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_4.sizePolicy().hasHeightForWidth())
        self.dotted_4.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.dquarter_pair_slider.setMaximum(30)
...
"}")
        ...
        self.eighth_pair_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted.sizePolicy().hasHeightForWidth())
        self.dotted.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.deighth_pair_slider.setMaximum(30)
...
"}")
        ...
        self.sixteenth_pair_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_2.sizePolicy().hasHeightForWidth())
        self.dotted_2.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.dsixteenth_pair_slider.setMaximum(30)
...
"}")
        ...
        self.thirtysecond_pair_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_13.sizePolicy().hasHeightForWidth())
        self.dotted_13.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.dthirtysecond_pair_slider.setMaximum(30)
...
"}")
        ...
        self.sixtyfourth_pair_slider.setMaximum(30)
        ...
        sizePolicy7.setHeightForWidth(self.dotted_14.sizePolicy().hasHeightForWidth())
        self.dotted_14.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.dsixtyfourth_pair_slider.setMaximum(30)
        ...
        sizePolicy11.setHeightForWidth(self.pair_len_weights_widget.sizePolicy().hasHeightForWidth())
        self.pair_len_weights_widget.setSizePolicy(sizePolicy11)
...
"}")
        ...
        sizePolicy9.setHeightForWidth(self.eighth_len_two.sizePolicy().hasHeightForWidth())
        self.eighth_len_two.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.eighth_len_three.sizePolicy().hasHeightForWidth())
        self.eighth_len_three.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.eighth_len_four.sizePolicy().hasHeightForWidth())
        self.eighth_len_four.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.eighth_len_five.sizePolicy().hasHeightForWidth())
        self.eighth_len_five.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.eighth_len_six.sizePolicy().hasHeightForWidth())
        self.eighth_len_six.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.eighth_len_seven.sizePolicy().hasHeightForWidth())
        self.eighth_len_seven.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.eighth_len_eight.sizePolicy().hasHeightForWidth())
        self.eighth_len_eight.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixteenth_len_one.sizePolicy().hasHeightForWidth())
        self.sixteenth_len_one.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixteenth_len_three.sizePolicy().hasHeightForWidth())
        self.sixteenth_len_three.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixteenth_len_four.sizePolicy().hasHeightForWidth())
        self.sixteenth_len_four.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixteenth_len_five.sizePolicy().hasHeightForWidth())
        self.sixteenth_len_five.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixteenth_len_six.sizePolicy().hasHeightForWidth())
        self.sixteenth_len_six.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixteenth_len_seven.sizePolicy().hasHeightForWidth())
        self.sixteenth_len_seven.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixteenth_len_eight.sizePolicy().hasHeightForWidth())
        self.sixteenth_len_eight.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.thirtysecond_len_two.sizePolicy().hasHeightForWidth())
        self.thirtysecond_len_two.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.thirtysecond_len_three.sizePolicy().hasHeightForWidth())
        self.thirtysecond_len_three.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.thirtysecond_len_four.sizePolicy().hasHeightForWidth())
        self.thirtysecond_len_four.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.thirtysecond_len_five.sizePolicy().hasHeightForWidth())
        self.thirtysecond_len_five.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.thirtysecond_len_six.sizePolicy().hasHeightForWidth())
        self.thirtysecond_len_six.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.thirtysecond_len_seven.sizePolicy().hasHeightForWidth())
        self.thirtysecond_len_seven.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.thirtysecond_len_eight.sizePolicy().hasHeightForWidth())
        self.thirtysecond_len_eight.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixtyfourth_timesig_two.sizePolicy().hasHeightForWidth())
        self.sixtyfourth_timesig_two.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixtyfourth_timesig_three.sizePolicy().hasHeightForWidth())
        self.sixtyfourth_timesig_three.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixtyfourth_timesig_four.sizePolicy().hasHeightForWidth())
        self.sixtyfourth_timesig_four.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixtyfourth_timesig_five.sizePolicy().hasHeightForWidth())
        self.sixtyfourth_timesig_five.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixtyfourth_timesig_six.sizePolicy().hasHeightForWidth())
        self.sixtyfourth_timesig_six.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixtyfourth_timesig_seven.sizePolicy().hasHeightForWidth())
        self.sixtyfourth_timesig_seven.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.sixtyfourth_timesig_eight.sizePolicy().hasHeightForWidth())
        self.sixtyfourth_timesig_eight.setSizePolicy(sizePolicy9)
        ...
        sizePolicy12.setHeightForWidth(self.keysig_widget.sizePolicy().hasHeightForWidth())
        self.keysig_widget.setSizePolicy(sizePolicy12)
        ...
        sizePolicy13.setHeightForWidth(self.keysig_spacewidget.sizePolicy().hasHeightForWidth())
        self.keysig_spacewidget.setSizePolicy(sizePolicy13)
        ...
        sizePolicy14.setHorizontalStretch(6)
        sizePolicy14.setVerticalStretch(0)
        sizePolicy14.setHeightForWidth(self.ranges_widget.sizePolicy().hasHeightForWidth())
        self.ranges_widget.setSizePolicy(sizePolicy14)
...
"}")
        ...
        sizePolicy7.setHeightForWidth(self.sharp_ranges.sizePolicy().hasHeightForWidth())
        self.sharp_ranges.setSizePolicy(sizePolicy7)
...
"}")
        ...
        sizePolicy15.setHeightForWidth(self.spacerwidget_2.sizePolicy().hasHeightForWidth())
        self.spacerwidget_2.setSizePolicy(sizePolicy15)
        ...
        sizePolicy16.setHorizontalStretch(6)
        sizePolicy16.setVerticalStretch(0)
        sizePolicy16.setHeightForWidth(self.anchors_arch_widget.sizePolicy().hasHeightForWidth())
        self.anchors_arch_widget.setSizePolicy(sizePolicy16)
...
"}")
        ...
        sizePolicy11.setHeightForWidth(self.anchor_templates_label.sizePolicy().hasHeightForWidth())
        self.anchor_templates_label.setSizePolicy(sizePolicy11)
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.anchors_template_bar.sizePolicy().hasHeightForWidth())
        self.anchors_template_bar.setSizePolicy(sizePolicy6)
        ...
        sizePolicy17 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        sizePolicy17.setHorizontalStretch(2)
        sizePolicy17.setVerticalStretch(0)
        sizePolicy17.setHeightForWidth(self.anchors_config_combo.sizePolicy().hasHeightForWidth())
        self.anchors_config_combo.setSizePolicy(sizePolicy17)
        ...
        sizePolicy18.setHeightForWidth(self.anchors_save_template.sizePolicy().hasHeightForWidth())
        self.anchors_save_template.setSizePolicy(sizePolicy18)
        ...
        sizePolicy19.setHeightForWidth(self.anchors_refresh_template.sizePolicy().hasHeightForWidth())
        self.anchors_refresh_template.setSizePolicy(sizePolicy19)
        ...
        sizePolicy19.setHeightForWidth(self.anchors_delete_template.sizePolicy().hasHeightForWidth())
        self.anchors_delete_template.setSizePolicy(sizePolicy19)
...
"}")
        ...
        sizePolicy11.setHeightForWidth(self.tertiary_spawn_dial.sizePolicy().hasHeightForWidth())
        self.tertiary_spawn_dial.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.tertiary_spawn_display.sizePolicy().hasHeightForWidth())
        self.tertiary_spawn_display.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.secondary_spawn_dial.sizePolicy().hasHeightForWidth())
        self.secondary_spawn_dial.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.secondary_spawn_display.sizePolicy().hasHeightForWidth())
        self.secondary_spawn_display.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.secondary_longevity_dial.sizePolicy().hasHeightForWidth())
        self.secondary_longevity_dial.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.secondary_longevity_display.sizePolicy().hasHeightForWidth())
        self.secondary_longevity_display.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.tertiary_longevity_dial.sizePolicy().hasHeightForWidth())
        self.tertiary_longevity_dial.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.tertiary_longevity_display.sizePolicy().hasHeightForWidth())
        self.tertiary_longevity_display.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.primary_label.sizePolicy().hasHeightForWidth())
        self.primary_label.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.primary_gravity_dial.sizePolicy().hasHeightForWidth())
        self.primary_gravity_dial.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.primary_gravity_display.sizePolicy().hasHeightForWidth())
        self.primary_gravity_display.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.secondary_label.sizePolicy().hasHeightForWidth())
        self.secondary_label.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.secondary_gravity_dial.sizePolicy().hasHeightForWidth())
        self.secondary_gravity_dial.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.secondary_gravity_display.sizePolicy().hasHeightForWidth())
        self.secondary_gravity_display.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.tertiary_label.sizePolicy().hasHeightForWidth())
        self.tertiary_label.setSizePolicy(sizePolicy11)
...
"}")
        ...
        sizePolicy11.setHeightForWidth(self.tertiary_gravity_dial.sizePolicy().hasHeightForWidth())
        self.tertiary_gravity_dial.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.tertiary_gravity_display.sizePolicy().hasHeightForWidth())
        self.tertiary_gravity_display.setSizePolicy(sizePolicy11)
...
"}")
        ...
        sizePolicy11.setHeightForWidth(self.tertiary_velocity_dial.sizePolicy().hasHeightForWidth())
        self.tertiary_velocity_dial.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.tertiary_velocity_display.sizePolicy().hasHeightForWidth())
        self.tertiary_velocity_display.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.secondary_velocity_dial.sizePolicy().hasHeightForWidth())
        self.secondary_velocity_dial.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.secondary_velocity_display.sizePolicy().hasHeightForWidth())
        self.secondary_velocity_display.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.primary_velocity_dial.sizePolicy().hasHeightForWidth())
        self.primary_velocity_dial.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.primary_velocity_display.sizePolicy().hasHeightForWidth())
        self.primary_velocity_display.setSizePolicy(sizePolicy11)
        ...
        sizePolicy20.setHeightForWidth(self.spacerwidget.sizePolicy().hasHeightForWidth())
        self.spacerwidget.setSizePolicy(sizePolicy20)
...
"")
        ...
        sizePolicy11.setHeightForWidth(self.compose_active_configuration_label.sizePolicy().hasHeightForWidth())
        self.compose_active_configuration_label.setSizePolicy(sizePolicy11)
...
"")
        ...
        sizePolicy11.setHeightForWidth(self.widget_16.sizePolicy().hasHeightForWidth())
        self.widget_16.setSizePolicy(sizePolicy11)
...
"}")
        ...
        sizePolicy7.setHeightForWidth(self.length_label.sizePolicy().hasHeightForWidth())
        self.length_label.setSizePolicy(sizePolicy7)
...
"}")
        ...
        sizePolicy7.setHeightForWidth(self.corner_logo.sizePolicy().hasHeightForWidth())
        self.corner_logo.setSizePolicy(sizePolicy7)
        ...
        sizePolicy11.setHeightForWidth(self.version_display.sizePolicy().hasHeightForWidth())
        self.version_display.setSizePolicy(sizePolicy11)
...
"}")
        ...
        sizePolicy8.setHeightForWidth(self.active_style_label.sizePolicy().hasHeightForWidth())
        self.active_style_label.setSizePolicy(sizePolicy8)
        ...
        sizePolicy8.setHeightForWidth(self.topBar_active_style_display.sizePolicy().hasHeightForWidth())
        self.topBar_active_style_display.setSizePolicy(sizePolicy8)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bpm_entry.setInputMask(QCoreApplication.translate("MainWindow", u"99", None))
